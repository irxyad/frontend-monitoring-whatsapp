    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar-background group-data-[variant=floating]:ring-sidebar-border flex size-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1"
        >
          {children}
        </div>
      </div>
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      variant="outline"
      className={cn(className, 'size-9 rounded-full p-0')}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
...
const sidebarMenuButtonVariants = cva(
  'hover:pl-5 bg-transparent peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md px-2 py-5 text-left text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:cursor-pointer  focus-visible:ring-2  disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50  data-active:font-medium data-active:text-white [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate',
  {
    variants: {
      variant: {
        default: '',
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive || undefined}
      className={cn(
        'ring-sidebar-ring hover:text-sidebar-primary-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground data-active:bg-primary [&>svg]:text-sidebar-accent-foreground flex h-7 w-full min-w-0 items-center gap-2 overflow-hidden rounded-md px-2 text-white outline-hidden transition-all ease-linear group-data-[collapsible=icon]:hidden hover:bg-white/10 hover:pl-5 focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-active:text-white data-[size=md]:text-sm data-[size=sm]:text-xs [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
        className
      )}
      {...props}
    />
